import 'package:baseer_application_1/pages/priceRE.dart';
...
class price extends StatefulWidget {
  ...
  @override
  State<price> createState() => _pricePageState();
}

// Add the WidgetsBindingObserver mixin
// ignore: camel_case_types
class _pricePageState extends State<price> with WidgetsBindingObserver {
...
Future<void> _scanImage() async {
  ...
  //final pictureFile = await _cameraController!.takePicture();
            ...
            await Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => priceRE(imagePath: image.path),
              ),
            );
          } catch (e) {
